...
<script>
import RecallHome from '@/components/recalls/RecallHome'
import RecallSettings from '@/components/recalls/RecallSettings'
import RecallAdditional from '@/components/recalls/RecallAdditional'
import RecallSummary from '@/components/recalls/RecallSummary'
export default {
  components: {
    RecallHome,
    RecallSettings,
